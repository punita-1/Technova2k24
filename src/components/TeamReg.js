        ...
        <main class="mainteam">
          <form action="" id="TeamForm" >
            ...
            <div class="form-item box-itemteam" style={{ marginBottom: '30px' }}>
              <input id="teamname" type="text" name="teamname" placeholder="Team Name" onChange={aa} data-required />
            ...
            <div class="" id='1'>
              ...
              <div className='row'>
                <div class="form-item box-itemteam">
                  <input id="name1" type="text" name="name1" placeholder="1st Member" onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                  <small class="errorEmail"><i class="fa fa-asterisk" aria-hidden="true"></i> email is not valid</small>
                </div>
                <div class="form-item box-itemteam">
                  <input id="email1" type="email" name="email1" placeholder="Email" data-email onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                </div>
              </div>
              <div className='row'>
                <div class="form-item box-itemteam">
                  <input id="phone1" type="number" name="phone1" placeholder="Phone no." onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                  <small class="errorEmail"><i class="fa fa-asterisk" aria-hidden="true"></i> email is not valid</small>
                </div>
                <div class="form-item box-itemteam">
                  <input id="roll1" type="number" name="rollnumber1" placeholder="Roll Number" data-email onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                </div>
              </div>
            </div>
            <div class={true ? " animate_animated animate_slideInDown" : "d-none"} id='2'>
              <span className="w-auto fs-5 text-dark fw-bold">Member 2</span>
              <div className='row'>
                <div class="form-item box-itemteam">
                  <input id="name2" type="text" name="name2" placeholder="2nd Member" onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                  <small class="errorEmail"><i class="fa fa-asterisk" aria-hidden="true"></i> email is not valid</small>
                </div>
                <div class="form-item box-itemteam">
                  <input id="email2" type="email" name="email2" placeholder="Email" data-email onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                </div>
              </div>
              <div className='row'>
                <div class="form-item box-itemteam">
                  <input id="phone2" type="number" name="phone2" placeholder="Phone no." onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                  <small class="errorEmail"><i class="fa fa-asterisk" aria-hidden="true"></i> email is not valid</small>
                </div>
                <div class="form-item box-itemteam">
                  <input id="roll2" type="number" name="rollnumber2" placeholder="Roll Number" data-email onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                </div>
              </div>
            </div>
            <div class={true ? " animate_animated animate_slideInDown" : "d-none"} id='3'>
              <span className="w-auto fs-5 text-dark fw-bold">Member 3</span>
              <div className='row'>
                <div class="form-item box-itemteam">
                  <input id="name3" type="text" name="name3" placeholder="3rd Member" onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                  <small class="errorEmail"><i class="fa fa-asterisk" aria-hidden="true"></i> email is not valid</small>
                </div>
                <div class="form-item box-itemteam">
                  <input id="email3" type="email" name="email3" placeholder="Email" data-email onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                </div>
              </div>
              <div className='row'>
                <div class="form-item box-itemteam">
                  <input id="phone3" type="number" name="phone3" placeholder="Phone no." onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                  <small class="errorEmail"><i class="fa fa-asterisk" aria-hidden="true"></i> email is not valid</small>
                </div>
                <div class="form-item box-itemteam">
                  <input id="roll3" type="number" name="rollnumber3" placeholder="Roll Number" data-email onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                </div>
              </div>
            </div>
            <div class={true ? " animate_animated animate_slideInDown" : "d-none"} id='4'>
              <span className="w-auto fs-5 text-dark fw-bold">Member 4</span>
              <div className='row'>
                <div class="form-item box-itemteam">
                  <input id="name4" type="text" name="name4" placeholder="4th Member" onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                  <small class="errorEmail"><i class="fa fa-asterisk" aria-hidden="true"></i> email is not valid</small>
                </div>
                <div class="form-item box-itemteam">
                  <input id="email4" type="email" name="email4" placeholder="Email" data-email onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                </div>
              </div>
              <div className='row'>
                <div class="form-item box-itemteam">
                  <input id="phone4" type="number" name="phone4" placeholder="Phone no." onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                  <small class="errorEmail"><i class="fa fa-asterisk" aria-hidden="true"></i> email is not valid</small>
                </div>
                <div class="form-item box-itemteam">
                  <input id="roll4" type="number" name="rollnumber4" placeholder="Roll Number" data-email onChange={aa} data-required />
                  <small class="errorReq"><i class="fa fa-asterisk" aria-hidden="true"></i> required field</small>
                </div>
              </div>
            </div>
            ...
            <div className='row'>
              <span className={!true ? 'btn btn-light fs-6 my-2 rounded-pill disabled d-none' : 'btn btn-light fs-6 my-2 rounded-pill animate_animated animate_slideInUp'} onClick={aa}>
            ...
            <div class="form-item my-3 mx-auto">
              <button class="submitteam" id="sbtn" onClick={aa} >Submit</button>
            </div>
          </form>
        </main>
